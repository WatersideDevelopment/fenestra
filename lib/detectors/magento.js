...
var getSessionKey = function(req) {
    ...
    console.log("looking for session in cookie (for session key): ");
    console.log(req.cookies);
    console.log("seeking frontend");
    console.log(req.cookies.frontend);
    return (req.cookies.frontend);
};

var getUserKey = function(req) {
    if(typeof req.cookies == "undefined") cookieParse(req);
    console.log("looking for session in cookie (for user key): ");
    console.log(req.cookies);
    console.log("seeking CUSTOMER");
    console.log(req.cookies.CUSTOMER);
